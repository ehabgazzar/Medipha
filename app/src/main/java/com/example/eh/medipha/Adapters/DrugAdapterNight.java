...
public class DrugAdapterNight extends  RecyclerView.Adapter<DrugAdapterNight.ViewHolder> {
    ...
    public DrugAdapterNight(Context context, List<Drug> drugItemObjects) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(parent.getContext()).inflate(R.layout.drag_item_night,parent,false);
