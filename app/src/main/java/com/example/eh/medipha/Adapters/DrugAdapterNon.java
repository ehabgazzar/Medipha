...
public class DrugAdapterNon extends  RecyclerView.Adapter<DrugAdapterNon.ViewHolder> {
    ...
    public DrugAdapterNon(Context context, List<Drug> drugItemObjects) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(parent.getContext()).inflate(R.layout.drag_item_non,parent,false);
