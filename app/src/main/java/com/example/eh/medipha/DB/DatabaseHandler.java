package com.example.eh.medipha.DB;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_DrugS_TABLE = "CREATE TABLE " + TABLE_DrugS + "("
    ...
    public void addDrug(Drug drug) {
        ...
        values.put(KEY_NAME, drug.getName()); // Drug Name
        values.put(KEY_TIME, drug.getTime()); // Drug Phone
    ...
    public List<Drug> getAllDrugs() {
        ...
        if (cursor.moveToFirst()) {
            do {
                Drug drug = new Drug();
                drug.set_id(Integer.parseInt(cursor.getString(0)));
                drug.setName(cursor.getString(1));
                drug.setTime(cursor.getString(2));
                drug.setState(Boolean.parseBoolean(cursor.getString(3)));
                // Adding Drug to list
                DrugList.add(drug);
